...
Number *Integer::add(Number * num) {
     ...
     *
     * enum 값은 INTEGER, FLOAT, COMPLEX 과 
     */


    if (num->types() == INTEGER) {
	int add_value = this->value + dynamic_cast<Integer*>(num)->val();
	Integer *result = new Integer(add_value);
	delete this;
        delete num;	
	return result;

    } else if (num->types() == FLOAT) {
	double add_value = this->value + dynamic_cast<Float*>(num)->val();
	Float *result = new Float(add_value);
	delete this;
	return result;
	

    } else if (num->types() == COMPLEX) {
	double add_value = this->value + dynamic_cast<Complex*>(num)->real();
	Complex *result = new Complex(add_value, dynamic_cast<Complex*>(num)->imag());
	delete this;
	return result;
...
Number *Integer::sub(Number * num) {
   ...
   if (num->types() == INTEGER) {
        int sub_value = this->value - dynamic_cast<Integer*>(num)->val();
        Integer* result = new Integer(sub_value);
        delete this;
        delete num;
        return result;

    } else if (num->types() == FLOAT) {
        double sub_value = this->value - dynamic_cast<Float*>(num)->val();
        Float *result =new Float(sub_value);
        delete this;
        return result;


    } else if (num->types() == COMPLEX) {
        double sub_value = this->value - dynamic_cast<Complex*>(num)->real();
        Complex *result = new Complex(sub_value, -dynamic_cast<Complex*>(num)->imag() );
        delete this;
        return result;
...
Number *Integer::mul(Number * num) {
     ...
     */
    if (num->types() == INTEGER) {
        int mul_value = this->value * dynamic_cast<Integer*>(num)->val();
        Integer* result =new Integer(mul_value);
        delete this;
        delete num;
        return result;

    } else if (num->types() == FLOAT) {
        double mul_value = this->value * dynamic_cast<Float*>(num)->val();
        Float *result =new Float(mul_value);
        delete this;
        return result;


    } else if (num->types() == COMPLEX) {
        double mul_value = this->value * dynamic_cast<Complex*>(num)->real();
	double mul_value2 = this->value * dynamic_cast<Complex*>(num)->imag();
        Complex* result = new Complex(mul_value , mul_value2);
        delete this;
        return result;
...
Number *Integer::div(Number * num) {
     ...
     */
if (num->types() == INTEGER) {
        int div_value = this->value / dynamic_cast<Integer*>(num)->val();
        Integer* result =new Integer(div_value);
        delete this;
        delete num;
        return result;

    } else if (num->types() == FLOAT) {
        double div_value = this->value / dynamic_cast<Float*>(num)->val();
        Float* result =new Float(div_value);
        delete this;
        return result;
