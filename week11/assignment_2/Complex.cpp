...
*/
	//std::pair<double, double> p1 = std::make_pair<0,0>;	
...
Number *Complex::add(Number * num) {
   ...
   if(num->types() == INTEGER){
        double val1_ = this->real() + dynamic_cast<Integer*>(num)->val();
	double val2_ = this->imag();
	Complex *result =new Complex(val1_, val2_);
        delete num;
        return result;

    } else if (num->types() == FLOAT) {
        double val1_ = this->real() + dynamic_cast<Float*>(num)->val();
        double val2_ = this->imag();
        Complex *result = new Complex(val1_, val2_);
        delete num;
        return result;
        ...
        double val1_ = this->real() + dynamic_cast<Complex*>(num)->real();
        double val2_ = this->imag() + dynamic_cast<Complex*>(num)->imag();
	Complex* result =new Complex(val1_ , val2_);
        delete this;
        delete num;
        return result;
...
Number *Complex::mul(Number * num) {
     ...
     */
     if(num->types() == INTEGER) {
        double val1_ = this->real() * dynamic_cast<Integer*>(num)->val();
        double val2_ = this->imag() * dynamic_cast<Integer*>(num)->val();
        Complex *result =new Complex(val1_ , val2_);
        delete num;
        ...
        double val1_ = this->real() * dynamic_cast<Float*>(num)->val();
        double val2_ = this->imag() * dynamic_cast<Float*>(num)->val();
        Complex *result = new Complex(val1_, val2_);
        delete num;
        return result;
        ...
        double val1_ = this->real() * dynamic_cast<Complex*>(num)->real() - this->imag() * dynamic_cast<Complex*>(num)->imag();
        double val2_ = this->real() * dynamic_cast<Complex*>(num)->imag() + this->imag() * dynamic_cast<Complex*>(num)->real();
        Complex *result = new Complex(val1_ , val2_);
        delete this;
        delete num;
        return result;
